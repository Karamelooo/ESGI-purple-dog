    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <Card>
                    <CardHeader className="pb-2">
                        <CardTitle className="text-sm font-medium text-gray-500">Ventes</CardTitle>
                    </CardHeader>
                    <CardContent>
                            ...
                            <tbody className="divide-y divide-gray-100">
                                {ads.map((ad) => (
                                    <tr key={ad.id} className="hover:bg-gray-50">
                                        ...
                                        <td className="px-4 py-3 uppercase text-xs font-bold text-gray-500">{ad.type === 'AUCTION' ? 'Enchère' : 'Vente'}</td>
                                        ...
                                        <td className="px-4 py-3 text-right">
                                            <Link href={`/ad/${ad.id}`}>
                                                <Button variant="ghost" size="sm">Gérer / Voir</Button>
                                            </Link>
                                        </td>
                                    </tr>
                                ))}
