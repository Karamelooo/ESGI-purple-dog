    ...
    <div>
      ...
      <section className="bg-gradient-to-r from-purple-800 to-indigo-900 text-white py-20 px-4 text-center">
        <div className="container mx-auto max-w-4xl">
          ...
          <p className="text-lg md:text-2xl text-purple-100 mb-10 max-w-2xl mx-auto">
            La plateforme de référence pour les particuliers et professionnels du marché de l&apos;art.
          </p>
          <div className="flex justify-center gap-4">
            <Link href="/register">
              <Button size="lg" className="bg-white text-purple-900 hover:bg-gray-100 font-bold text-lg px-8">
                Commencer à vendre
              </Button>
            </Link>
          </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 text-center max-w-3xl">
          <h2 className="text-3xl font-bold text-purple-900 mb-6">Pourquoi Purple Dog ?</h2>
          <p className="text-xl text-gray-600 leading-relaxed">
            Purple Dog est LA plateforme pour vendre mieux vos objets de valeurs à des tiers de confiance.
            Nous connectons des particuliers souhaitant vendre des biens d&apos;exception avec un réseau certifié d&apos;acheteurs professionnels.
            Simplicité, sécurité et transparence.
          </p>
        </div>
      </section>
